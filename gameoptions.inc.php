 ...
 * gameoptions.inc.php
 *
 * EclipticTravelers game options description
 *
 ...
 *        with the same ID (see "initGameStateLabels" in ecliptictravelers.game.php)
 *
...
$game_options = array(
    ...
    */
    ...
    100 => array(
        ...
        'values' => array(
            // A simple value for this option:
            1 => array( 'name' => totranslate('1 round') ),
            2 => array( 'name' => totranslate('2 rounds (default)') ),
            3 => array( 'name' => totranslate('3 rounds') ),
            4 => array( 'name' => totranslate('4 rounds') )
        ),
        'default' => 2
    )
);
